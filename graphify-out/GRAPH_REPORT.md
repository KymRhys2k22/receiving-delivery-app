...
## Corpus Check
- 49 files · ~136,892 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 523 nodes · 724 edges · 71 communities (31 shown, 40 thin omitted)
...
Cohesion: 0.07
Nodes (48): AiAssistantContext, AiAssistantContextType, AiAssistantProvider(), useAiAssistant(), AuthContext, AuthContextType, AuthProvider(), useAuth() (+40 more)

### Community 1 - "dlr.ts"
Cohesion: 0.10
Nodes (40): DamageLostRecordScreen(), feedback(), formatRecordTime(), Step, STEP_LIST, buildDlrImageName(), buildSupabasePayload(), CLOUDINARY_CLOUD_NAME (+32 more)
...
Cohesion: 0.22
Nodes (9): expo, expo-camera, dependencies, expo, expo-camera, react-native-svg, @react-navigation/bottom-tabs, react-native-svg (+1 more)
...
Cohesion: 0.15
Nodes (12): 🏪 1. Multi-Store Isolation for Damage Lost Record (DLR), 🔍 2. Intelligent Bidirectional SKU ↔ UPC Lookup, 📱 3. KeyboardAvoidingView & Modal UI Fix, 🔄 4. Semantic Versioning in App Update Service, 🖼️ 5. `expo-image` Named Import Fix, 🎨 6. Assistant Branding & UI Polish, Commit Scope & Modified Files, 📝 Git Commit & Tag Instructions (+4 more)

## Knowledge Gaps
- **274 isolated node(s):** `name`, `slug`, `version`, `favicon`, `tsconfigPaths` (+269 more)
